...
% (C1PHASE_DOXY, C2PHASE_DOXY and TEMP_DOXY) according to Case 202_205_302
% specifications.
%
% SYNTAX :
%  [o_doxyValues] = gl_compute_DOXY_case_202_205_302(a_timeValues, ...
...
% ------------------------------------------------------------------------------
function [o_doxyValues] = gl_compute_DOXY_case_202_205_302(a_timeValues, ...
   a_ctdValues, a_c1PhaseDoxyValues, a_c2PhaseDoxyValues, a_tempDoxyValues, ...
   a_timeGps, a_latitudeGps, a_longitudeGps)
...
if (~isempty(inputDoxyNoDef))
   ...
   if (~isempty(ctdIntData))
      ...
      if (~isempty(latIntGps))
         ...
         % compute DOXY
         o_doxyValues(inputDoxyNoDef) = compute_DOXY_202_205_302( ...
...
%
% SYNTAX :
%  [o_doxyValues] = compute_DOXY_202_205_302( ...
...
%   08/25/2016 - RNU - creation
% ------------------------------------------------------------------------------
function [o_doxyValues] = compute_DOXY_202_205_302( ...
   a_c1PhaseDoxyValues, a_c2PhaseDoxyValues, a_tempDoxyValues, ...
   a_presValues, a_tempValues, a_psalValues, ...
   a_latitude, a_longitude)
