...
%
% SYNTAX :
%  gl_generate_ego_1_3_checker_rules_file
%
% INPUT PARAMETERS :
%
% OUTPUT PARAMETERS :
...
% ------------------------------------------------------------------------------
function gl_generate_ego_1_3_checker_rules_file
...
% TEMPLATE_RULES_FILE_PATH_NAME = 'C:\Users\jprannou\NEW_20190125\_RNU\Glider\soft\util\ref_lists\EGO_V1.3_TEMPLATE_20180829.xml';
TEMPLATE_RULES_FILE_PATH_NAME = 'C:\Users\jprannou\NEW_20190125\_RNU\Glider\soft\util\ref_lists\EGO_V1.3_TEMPLATE_20190307.xml';
...
for idP = 1:length(paramDataStruct)
   ...
   var.core_bio_intermediate = paramStruct.core_bio_intermediate;
...
for idV = 1:length(a_tabVar)
   ...
   for idLoop = 1:3
      ...
      if (idLoop == 1)
         varSuffix = '';
      elseif (idLoop == 2)
         if (var.core_bio_intermediate == 'i')
            continue
         end
         varSuffix = '_ADJUSTED';
      else
